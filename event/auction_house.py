...
class AuctionHouse(Event):
    ...
    def mod(self):
        ...
        if self.args.auction_random_items:
            ...
            ### Mod to grant good items as replacements for normal AH items
            #self.cherub_down_new_item = self.items.get_good_random()
            #self.cure_ring_new_item = self.items.get_good_random()
            #self.hero_ring_new_item = self.items.get_good_random()
            #self.zephyr_cape_new_item = self.items.get_good_random()
