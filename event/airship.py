...
class Airship(Event):
    ...
    def mod(self):
        ...
        # Debug: use airship stairwell as warp point
##        src = [
##            field.FadeLoadMap(0x01, direction.DOWN, default_music = False,
##                              x = 81, y = 86, fade_in = False),
##            0xFF,
##            field.Return(),
##        ]
##        space = Write(Bank.CA, src, "test")
##                      
...
##        self.maps.add_event(6, new_event)
##
##        src = [
##            field.FadeLoadMap(0x0, direction.DOWN, default_music = False,
##                              x = 81, y = 86, fade_in = False),
##            0xFF,
##            field.Return(),
##        ]
##        space = Write(Bank.CA, src, "testtwo")
##                      
##        from data.map_event import MapEvent
##        new_event = MapEvent()
##        new_event.x = 17
...
##        self.maps.add_event(6, new_event)
    ...
    def controls_mod(self):
        ...
        space = Allocate(Bank.CA, 4, "skip to final battle", field.NOP())
        final_skip = space.start_address
        space.write(
            0x9d,
            0x4d, 0x65, 0x33,
        )
