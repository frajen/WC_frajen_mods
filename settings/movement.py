...
from data.movement import AUTO_SPRINT, B_DASH, ORIGINAL, SPRINT_SHOES_B_DASH, AUTO_DASH, MovementSpeed
...
class Movement:
    ...
    def get_auto_sprint_src(self):
        ...
        # force DASH speed with AUTO_SPRINT
        if self.movement == AUTO_DASH:
            src += [
                "STORE_DEFAULT",
                asm.A8(),
                asm.LDA(MovementSpeed.DASH, asm.IMM8),    
