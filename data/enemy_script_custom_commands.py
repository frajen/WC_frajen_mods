...
class EnemyScriptCommands:
    ...
    def random_tiered_ability_mod(self, space):
        ...
        ### There isn't any requirement for enemy levels per tier to limited to +3
        #ENEMY_LEVELS_PER_TIER = self.args.ability_scaling_factor + 20
        #print(self.args.ability_scaling_factor)
        #print(ENEMY_LEVELS_PER_TIER)
