...
def parse_script(script):
    CommonInstructionTypes = [ai_instr.RandomAttack, ai_instr.SetTarget,
                              ai_instr.SetFormation, ai_instr.Message,
                              ai_instr.RandomCommand, ai_instr.ChangeEnemies,
                              ai_instr.RandomItem, ai_instr.Event, ai_instr.Arithmetic,
                              ai_instr.Bits, ai_instr.Animate, ai_instr.Misc, ai_instr.If,
                              ai_instr.EndTurn, ai_instr.EndIf]
