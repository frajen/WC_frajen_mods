### Rank items for placement in chests
### Separation by ranked tier here is done independent of item type
### This is different from regular chest/shop group tiers, which ARE separated by item type
...
#weights = [0.10, 0.12, 0.03, 0.015, 0.005, 0.09, 0.25, 0.30, 0.085, 0.005]  #original weights
# weights re-ordered so that it increases probability the higher you go
weights = [0.40, 0.35, 0.25, 0.095, 0.005]
...
if args.stronger_atma_weapon:
    ...
    sorted_tiers[1].remove(name_id["Atma Weapon"])
    sorted_tiers[4].append(name_id["Atma Weapon"])
