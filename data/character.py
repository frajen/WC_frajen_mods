...
class Character():
    ...
    def __init__(self, id, init_data, name_data):
        ...
        ### natural magic flag, used to ensure characters with natural magic
        ### will have a Magic or X magic command
        self.natural_magic_user = 0
