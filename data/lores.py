...
class Lores:
    ...
    def start_random_lores(self):
        ...
        ### Remove high tier lores from starting options
##        nerfed_lores = list(range(self.LORE_COUNT))
##        high_tier_lores = [4, 5, 6, 21, 22]
##        for i in high_tier_lores:
##            nerfed_lores.remove(i)
##
##        if number_initial_lores > len(nerfed_lores):
##            number_initial_lores = len(nerfed_lores)
##        initial_lores = random.sample(nerfed_lores, number_initial_lores)
        ### Remove high tier lores from starting options
