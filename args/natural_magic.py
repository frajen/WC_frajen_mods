...
### mod to pick natural magic spells from the Random Tiered system
    natural_magic.add_argument("-rntiers1", "--random-tiered-natural-spells1", action = "store_true",
                               help = "Random Tiering applied to Terra's natural spells")
### mod to pick natural magic spells from the Random Tiered system
    natural_magic.add_argument("-rntiers2", "--random-tiered-natural-spells2", action = "store_true",
                               help = "Random Tiering applied to Celes' natural spells")
...
def flags(args):
    ...
    if args.random_natural_spells1:
        flags += " -rns1"
    ### mod to pick natural magic spells from the Random Tiered system
    elif args.random_tiered_natural_spells1:
        flags += " -rntiers1"
    ...
    if args.random_natural_spells2:
        flags += " -rns2"
    ### mod to pick natural magic spells from the Random Tiered system
    elif args.random_tiered_natural_spells2:
        flags += " -rntiers2"
...
def options(args):
    ...
    if args.random_natural_spells1:
        result.append(("Randomize Spells", args.random_natural_spells1))
    elif args.random_tiered_natural_spells1:
        result.append(("Random Tiered Spells", args.random_tiered_natural_spells1))

    result.append(("Natural Magic", natural_magic2))
    result.append(("Randomize Levels", args.random_natural_levels2))
    if args.random_natural_spells2:
        result.append(("Randomize Spells", args.random_natural_spells2))
    elif args.random_tiered_natural_spells2:
        result.append(("Random Tiered Spells", args.random_tiered_natural_spells2))

    result.append(("Menu Indicator", args.natural_magic_menu_indicator))
    return result
