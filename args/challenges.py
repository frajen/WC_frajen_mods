...
def parse(parser):
    ...
    ### apply "one of" logic to certain items in data\items.py get_good_random
    challenges.add_argument("-1of", "--one-of", action = "store_true",
                            help = "Only 1 of certain items will be placed as a check reward")

    ### door rando
    challenges.add_argument("-doorrand", "--door-rando", action = "store_true",
                            help = "Exits are randomized")   
...
def options(args):
    ...
    return [
        ...
        ("1 Of Logic", args.one_of),
        ("Door rando", args.door_rando),
    ]
