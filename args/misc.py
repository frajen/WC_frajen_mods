...
def parse(parser):
    ...
    ### new options    
    misc.add_argument("-morewarp", "--more-warp", action = "store_true",
                      help = "Add warpability to more maps")
    misc.add_argument("-ltier", "--location-tiering", action = "store_true",
                      help = "Applies location tiering to seed")
    misc.add_argument("-handles", "--hold-anything", action = "store_true",
                      help = "Characters can hold any item")
    misc.add_argument("-npctips", "--npc-dialog-tips", action = "store_true",
                      help = "NPC provide general game tips")
    
    # new mods for menu improvements
    misc.add_argument("-shopydetails", "--shop-y-details", action = "store_true",
                      help = "Hold Y in shop menus to see item details")
    misc.add_argument("-iidd", "--improved-item-detail-display", action = "store_true",
                      help = "Show more info in detailed item display")
...
def options(args):
    ...
    return [
        ...
        ("Shop Y Details", args.shop_y_details),
        ("Improved Item Display", args.improved_item_detail_display),
        ("More Warp", args.more_warp),
        ("Location Tiering", args.location_tiering),
        ("Hold Anything", args.hold_anything),        
    ]
